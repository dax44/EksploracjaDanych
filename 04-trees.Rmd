...
\begin{equation}
    \P(d|\mathbf{n})=\P(T_\mathbf{n})(d)=\frac{|T_\mathbf{n}^d|}{|T_\mathbf{n}|},
\end{equation}
...
\begin{equation}
    \Delta E_{T_{\mathbf{n}, t=r}}(c|t)=E_{T_{\mathbf{n}, t=r}}(c)-E_{T_{\mathbf{n}, t=r}}(c|t).
\end{equation}
