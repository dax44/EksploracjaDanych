...
## Klasyfikator największej warogodności (ML)
...
Poniższe tabele zawierają warunkowe prawdopodobieństwa przynależności do poszczólnych klas.
...
Klasyfikacja na podstawie modelu jest badzo do dobra (96%).
